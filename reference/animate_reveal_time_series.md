...
Plot animated line graph showing parameter value vs dimension (revealed
in the animation) from algorithm output.
...
An animated line graph, which successively adds points along the time
axis.
